...
create_rates(filename = "ischaemic_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_107")
...
create_rates(filename = "cerebrovascular_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_116")
...
create_rates(filename = "neoplasms_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_125")
...
create_rates(filename = "motor_acc_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_164")
...
create_rates(filename = "suicide_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_173")
...
create_rates(filename = "homicide_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_182")
...
create_rates(filename = "all_cause_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_197")
...
create_rates(filename = "inf_parasite_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_206")
...
create_rates(filename = "respiratory_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_215")
...
create_rates(filename = "cld_cirrhosis_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_239")
# Endocrine, nutritional and metabolic diseases
create_rates(filename = "endocrine_deaths_allages", pop="allages", epop_total = 100000, ind_id="HFA_242")
create_rates(filename = "endocrine_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_245")
# Diabetes
create_rates(filename = "diabetes_deaths_allages", pop="allages", epop_total = 100000, ind_id="HFA_248")
create_rates(filename = "diabetes_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_251")
# Diseases of the blood, blood forming organs and certain immunity disorders
create_rates(filename = "blood_deaths_allages", pop="allages", epop_total = 100000, ind_id="HFA_254")
create_rates(filename = "blood_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_257")
# Mental disorders, diseases of nervous system and sense organs
...
create_rates(filename = "ill_defined_deaths_0to64", pop="0to64", epop_total = 80500, ind_id="HFA_278")
